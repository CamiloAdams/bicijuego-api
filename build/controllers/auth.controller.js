      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _req$body = req.body, username = _req$body.username, nombres = _req$body.nombres, apellidos = _req$body.apellidos, fecha_nacimiento = _req$body.fecha_nacimiento, email = _req$body.email, password = _req$body.password; //check if username or email already exists
            _context.next = 3;
